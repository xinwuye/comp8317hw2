...
case "${TARGET}" in
  all)
    echo "modelnet40 baseline $(submit_job modelnet40 cls-ptv3-v1m1-1-medium-baseline hw2-mn-baseline)"
    echo "modelnet40 gahs $(submit_job modelnet40 cls-ptv3-v1m1-2-medium-gahs hw2-mn-gahs)"
    echo "scanobjectnn baseline $(submit_job scanobjectnn cls-ptv3-v1m1-0-medium-baseline hw2-so-baseline)"
    echo "scanobjectnn gahs $(submit_job scanobjectnn cls-ptv3-v1m1-1-medium-gahs hw2-so-gahs)"
    ;;
  modelnet40)
    echo "modelnet40 baseline $(submit_job modelnet40 cls-ptv3-v1m1-1-medium-baseline hw2-mn-baseline)"
    echo "modelnet40 gahs $(submit_job modelnet40 cls-ptv3-v1m1-2-medium-gahs hw2-mn-gahs)"
